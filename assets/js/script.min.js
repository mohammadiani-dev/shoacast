...
var vue = __webpack_require__(/*! ./vue */ "./assets/js/vue.js");
...
var PodcastApp = {
  ...
  methods: {
    filter_podcast_by_guest: function filter_podcast_by_guest(term_id) {
      this.podcasts = SHOA_DATA.podcasts.filter(function (item) {
        return item.guest.id == term_id;
      });
    },
    reset_player: function reset_player() {
      this.$refs.current_time.textContent = "00:00";
      this.$refs.total_time.textContent = "00:00";
      this.$refs.slider_player.value = 0;
    },
    seekUpdate: function seekUpdate() {
      var seekPosition = 0;
      ...
      if (!isNaN(this.curr_track.duration)) {
        ...
        var currentMinutes = Math.floor(this.curr_track.currentTime / 60);
        var currentSeconds = Math.floor(this.curr_track.currentTime - currentMinutes * 60);
        var durationMinutes = Math.floor(this.curr_track.duration / 60);
        var durationSeconds = Math.floor(this.curr_track.duration - durationMinutes * 60);
    ...
    loadTrack: function loadTrack() {
      ...
      this.curr_track.addEventListener("ended", function () {
        ...
        _this.isplay = false;
        _this.show_music_player = false;
      });
    },
    playpauseTrack: function playpauseTrack(podcast) {
      ...
      this.show_video_player = false; // if (!this.isplay) this.playTrack();
      // else this.pauseTrack();

      var player = document.querySelector("shoacast_player");
      this.scrollToJustAbove(player);
    },
    playpauseVideo: function playpauseVideo(podcast) {
      // this.pauseTrack();
      this.podcast = podcast;
      this.show_music_player = false;
      this.show_video_player = true;
      var player = document.querySelector("shoacast_player");
      this.scrollToJustAbove(player); // var video = document.getElementById("shoa_video_player_wrapper");
    ...
    scrollToJustAbove: function scrollToJustAbove(element) {
      console.log(element);
      window.scrollTo({
  ...
  watch: {
    serach_text: function serach_text(before, value) {
    ...
    sort: function sort(before, value) {
      switch (value) {
        case 'newest':
  ...
  mounted: function mounted() {
    ...
    this.podcasts = SHOA_DATA.podcasts;
    this.guests = SHOA_DATA.guests; // document.getElementById("shoa_volume_music_slider").oninput = function() {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkshoa_podcast_service"] = self["webpackChunkshoa_podcast_service"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["assets/css/style","assets/css/admin-style"], () => (__webpack_require__("./assets/js/owl.carousel.min.js")))
/******/ 	__webpack_require__.O(undefined, ["assets/css/style","assets/css/admin-style"], () => (__webpack_require__("./assets/js/script.js")))
/******/ 	__webpack_require__.O(undefined, ["assets/css/style","assets/css/admin-style"], () => (__webpack_require__("./assets/css/style.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["assets/css/style","assets/css/admin-style"], () => (__webpack_require__("./assets/css/admin-style.scss")))
